...
function diff_match_patch() {
  ...
  this.Patch_DeleteThreshold = 0.375;
...
diff_match_patch.prototype.patch_apply = function(patches, text) {
  ...
  console.dir([text, results, positions]);
  ...
  while (textPointer < text.length) {
    ...
    while (textPointer < text.length) {
      ...
      try {
        ...
        // Malformed URI sequence.
        throw new Error("Illegal escape in patch_fromText: " + line + " e: " + ex + " text: " + text);
      }
      if (sign == '-') {
        // Deletion.
